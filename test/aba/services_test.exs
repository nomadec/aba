defmodule Aba.ServicesTest do
  ...
  describe "services" do
    ...
    @valid_attrs %{description: "some description", duration: 42, location: "some location", name: "some name", price: 120.5, user_id: "7488a646-e31f-11e4-aace-600308960662"}
    @update_attrs %{description: "some updated description", duration: 43, location: "some updated location", name: "some updated name", price: 456.7, user_id: "7488a646-e31f-11e4-aace-600308960668"}
    ...
    test "create_service/1 with valid data creates a service" do
      ...
      assert service.user_id == "7488a646-e31f-11e4-aace-600308960662"
    end
    ...
    test "update_service/2 with valid data updates the service" do
      ...
      assert service.user_id == "7488a646-e31f-11e4-aace-600308960668"
    end
